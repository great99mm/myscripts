...
if [[ $EUID -ne 0 ]]; then
    exec sudo --preserve-env=SRC_DIR,DST_DIR,STAGE_DIR,LOG_DIR,LOCK_FILE,RETRY_TIMES,RETRY_DELAY,STABLE_CHECKS,STABLE_INTERVAL,OVERWRITE,CLEAN_EMPTY_DIRS,CHECK_MOUNTPOINT,ENABLE_NOW,DRY_RUN,CONCURRENCY,TG_BOT_TOKEN,TG_CHAT_ID bash "$INSTALL_SCRIPT"
else
